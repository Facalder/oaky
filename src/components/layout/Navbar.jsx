...
const Navbar = () => {
  return (
    <header className="h-20 flex justify-end items-center px-8 gap-4 shrink-0">
      ...
      <Link href="/plans" className="flex items-center gap-2 px-4 py-2 bg-white text-[#5b45c2] border border-[#e5e1f1] rounded-xl text-sm font-semibold shadow-sm hover:bg-gray-50 transition-colors">

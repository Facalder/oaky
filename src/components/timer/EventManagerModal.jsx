...
import { ChevronLeft, Edit2, MoreVertical, Plus, Trash2 } from 'lucide-react'
                        ...
                        >
                          ...
                          <div className='opacity-0 group-hover:opacity-100 flex gap-2 transition-opacity'>
                            <button
                              ...
                              className='p-1.5 text-gray-400 hover:text-blue-500 bg-white shadow-sm rounded-lg'
                            >
                              <Edit2 size={14} />
                            </button>
                            <button
                              onClick={(e) => handleDelete(ev.id, e)}
                              className='p-1.5 text-gray-400 hover:text-red-500 bg-white shadow-sm rounded-lg'
                            >
                              <Trash2 size={14} />
                            </button>
                          </div>
